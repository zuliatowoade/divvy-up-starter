...
@RequestMapping("/friends")
    public class FriendsController {
        ...
        @PostMapping("/create")
        public ResponseEntity<org.example.expensedatamanager.model.Friends> createFriendship(@RequestBody CreateFriendsRequest request) {
            try {
                org.example.expensedatamanager.model.Friends friendship = friendsService.createFriendship(request);
