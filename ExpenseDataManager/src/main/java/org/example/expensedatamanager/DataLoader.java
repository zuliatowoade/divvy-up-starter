...
public class DataLoader {
    ...
    public void loadData() {
        ...
        var friends4 = new User(null, "cthomson","Chris", "Thomson", "chris.thomson@example.com", "333-444-5553");
        userRepository.save(friends4);

        friendRepository.save(new Friends(null, friends4, friend1, friends4.getUsername()));
        friendRepository.save(new Friends(null, friends4, friend2, friends4.getUsername()));
        friendRepository.save(new Friends(null, friends4, friend3, friends4.getUsername()));
